...
import { optionState, optionEndPoints } from "./PageSettings";
...
const Controller = () => {
  ...
  const [serviceType, getServiceType] = useSelectOption(path, optionState, optionEndPoints.servicetype, simpleDataReducer);
  ...
  return (
    <Fragment>
      <SubHeader title="Groom" buttons={navButtons} actions={{ btnBack: handleBack }} />
