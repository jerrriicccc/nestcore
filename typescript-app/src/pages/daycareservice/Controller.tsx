...
const Controller = () => {
  ...
  const [serviceType, getServiceType] = useSelectOption(path, optionState, optionEndPoints.cattype, simpleDataReducer);
  ...
  const cardSubmitHandler = useCardFormSubmitHandler({
    ...
    options: {
      ...
      onSuccess: () => {
        ...
        emptyFormFields();
        navigate("/daycareservice/create");
      },
    },
  });
  ...
  return (
    <Fragment>
      <SubHeader title="Daycare" buttons={navButtons} actions={{ btnBack: handleBack }} />
