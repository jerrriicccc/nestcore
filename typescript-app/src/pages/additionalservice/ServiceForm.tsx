...
const CustomerForm = ({ data = { additionalservice: "", price: "" }, onChange, onSubmit, handleCancelEditForm }: ServiceFormProps) => {
  ...
  return (
    <tr>
      <td>
        <TextInput name="additionalservice" label="Add" onChange={onChange} data={data.additionalservice} className="form-input input-field" error={errors.additionalservice} />
      </td>
      <td>
