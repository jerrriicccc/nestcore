...
const Controller = () => {
  /** -------------------------------- SERVICE FORM DATA INITIALIZATION ------------------------------------  **/
  ...
  const cardSubmitHandler = useCardFormSubmitHandler({
    ...
    options: {
      ...
      onSuccess: () => {
        ...
        emptyFormFields();
        navigate("/additionalservice/create");
      },
    },
  });
  ...
  /** -------------------------------- SERVICE TABLE DATA INITIALIZATION ------------------------------------  **/
  ...
  return (
    <Fragment>
      <SubHeader title="Additional Service" searchPane={<SearchPane onSearch={handleSearch} />} buttons={navButtons} actions={{ btnBack: handleBack }} />
      ...
      <div className="px-4">
        {isLoading ? (
          ...
          <>
            <ServiceTable data={serviceTable?.data || []} actions={tableActions} formData={serviceForm.data} onChange={handleChange} onSubmit={handleSubmit} handleCancelEditForm={handleCancel} />
          </>
        )}
      </div>
