...
import TimeScheduleForm from "./TimeScheduleForm"; // Import the form
...
const TimeScheduleTable = ({ data, actions, formData, onChange, onSubmit, handleCancelEditForm }: ServiceTableProps) => {
    ...
    <FormTable
      ...
      formRow={
        formData && onChange && onSubmit && handleCancelEditForm
          ? () => <TimeScheduleForm data={formData} onChange={onChange} onSubmit={onSubmit} handleCancelEditForm={handleCancelEditForm} />
          : undefined
      }
    />
  );
