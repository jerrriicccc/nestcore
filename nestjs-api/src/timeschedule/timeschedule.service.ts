...
export class TimeScheduleService {
  ...
  constructor(
    ...
    private readonly timeScheduleServiceRepository: Repository<TimeScheduleEntity>,
  ) {}
  ...
  async findPaginated(
    entity: EntityTarget<TimeScheduleEntity>,
    page = 1,
    searchCond = '',
    ...
    try {
      ...
      const result = await paginate<TimeScheduleEntity>(queryBuilder, {
