...
import { RoleAccessTypesService } from 'src/roleaccesstypes/roleaccesstype.service';
import { RoleAccessOptionsService } from 'src/roleaccessoptions/roleaccessoption.service';
import { CreateDto as CreateRoleLineDto } from 'src/rolelines/dto/roleline.dto';
import { RoleLine } from '../rolelines/entity/roleline.entity';
import { RoleLinesService } from 'src/rolelines/roleline.service';
...
export class RoleAccessDetailsController {
  ...
  async delete(@Body('id', ParseIntPipe) id: number) {
    return this.roleAccessDetailsService.delete(RoleAccessDetail, id);
  }
}
