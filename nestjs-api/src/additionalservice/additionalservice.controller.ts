...
export class AdditionalServicesController {
  ...
  async findAll(@Query() query: PaginationQuery, @Req() req: Request) {
    ...
    return await this.additionalService.findPaginated(
  ...
  async findOne(@Query('id', ParseIntPipe) id: number) {
    ...
    const result = await this.additionalService.findOne(
      AdditionalServiceEntity,
      id,
    );
    return { data: result };
  ...
  async create(@Body() createDto: CreateDto) {
    const result = await this.additionalService.create(
      AdditionalServiceEntity,
      createDto,
    );
    return { data: result };
  ...
  async update(@Body() updateDto: UpdateDto) {
    ...
    const result = await this.additionalService.update(
      AdditionalServiceEntity,
      updateDto.id,
      updateDto,
    );
  ...
  async delete(@Body('id', ParseIntPipe) id: number) {
    ...
    return await this.additionalService.delete(AdditionalServiceEntity, id);
  }
}
